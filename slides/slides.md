...
>>>
+ Another sermon about **money**:
  + be **frugal**, give more to **church**?
+ **What** money? 60% goes to housing
+ **My** money, don't I have the **right**?
+ How I **earn**, save, spend reveals
  + **priorities**, goals, character
...
>>>
+ Use resources + rl to show **mercy**
+ Be **faithful** stewards in all things:
  + of which money is the **smallest**!
+ Never lose sight of pure, devoted,
  + exclusive **love** for God
+ Parable of **unrighteous** mgr
  + bit **hard** to underst
+ Jesus uses wisdom of **worldly** to
  + show how to be even **more** wise
...
我知道怎麼行，好叫人在我不作管家之後，<br/>
接我到他們家裡去。

[Luke 16:4 (ESV/CUV)](# "ref")
[Julian Böck](https://unsplash.com/photos/agS-BtrQZrs "caption")

>>>
+ Curry **favour** w/other houses
  + Secure **future** position for himself
+ **Scheming**, self-serving
+ Recall orig **reason** mgr was fired 
  + was **wasting** money (v1):
...
[Luke 16:1 (ESV/CUV)](# "ref")
[Angelina Litvin](https://unsplash.com/photos/K3uOmmlQmOo "caption")

>>>
+ note: not **stealing** (embezzlement) 
+ but **scattering**: 
  + not specified **how**
  + money is just **gone**
+ **Now**, mgr gives hefty **discounts** 
  + to **protect** own future career
+ What's really **surprising** is
  + how the **master** responds:
...
[Luke 16:8b (ESV/CUV) (p.2/2)](# "ref")

>>>
+ Master also **son** of this age
+ "I **get** it -- looking out for **self**
  + still very **fired**, but I'd do **same**
+ **Why**? **Relationship** > money:
+ Cash has no **intrinsic** worth/utility
  + **Proxy** for value
+ Virtue isn't how **much** we save, but
...
+ Donating to charity **entitles** me to do
  + what I **want** w/rest of my money
...
+ In **trusting** env of church, we forget 
  + **shrewdness** praised by master
+ We neglect study **how** to **use** money
  + Jesus says sth super **confusing**:
...
[Luke 16:9b (ESV/CUV) (p.2/2)](# "ref")

>>>
+ **Mammon**: Aram. "in which we **trust**"
  + (only here and parallel in Mt6:24)
+ Not morally **neutral**, but can **use**
  + to demonstrate **friendship**,
  + concern, or **mercy**
+ Will **fail** (quit, end, eclipse)
  + but our **home** lasts to **eternity**
+ Not **house** but **tent**, as in wilder.
  + rather **corner** of tent God's king.
  + than **mansion** on fleeting riches
...
+ as hholds **welcomed** shrewd **mgr** 
+ 3 levels of **application**:
+ (1) make peace w/ **God**:
  + **all** our rsrcs from God's mercy
  + **tithe** + offer part of **worship**
+ (2) **Saints** that go before: 
  + **sharing** burdens as one body
+ (3) **Biz partners**: in world
  + to be a **witness** of mercy
  + **draw** them to Christ's mercy
...
[Luke 16:9a (ESV/CUV)](# "ref")
[Benjamin Child](https://unsplash.com/photos/GWe0dlVD9e0 "caption")

>>>
+ so Jesus wants us to **buy** friends?
  + mixing **biz** + **personal**: sketchy!
+ bank **bday** gifts: not friends!
+ **guanxi**: "family" discount
+ Why bad? **abuse** rl for pers **gain**
+ Not the **mix** of money w/rl that's bad
  + But **prioritising** money over rl
+ So **expend** money, time to build rl 
...
>>>
+ Students: pract. **dealings** w/world
+ Not **demanding** full extent of law
  + but seek **fair** + equitable dealings
+ As **consumers**, employees/ers:
...
+ If we are **profligate** 
  + with **resources** from God,
+ That's not **trust** in God's protect
  + but lack of **faithfulness**
+ v10-12, 3 **contrasts**:

---
<!-- .slide: <%= bg("unsplash-lZ_4nPFKcV8-money_leaf.jpg") %> -->
One who is faithful in a **very little**<br>
is also faithful in **much**, <br/>
...
[Luke 16:12 (ESV/CUV) (p.3/3)](# "ref")

>>>
+ least vs **abundance**, 
  + unrighteousness vs **true** riches,
  + another's vs your **own**
+ Money is of **little** value!
  + Can be **unrighteous**: 
  + ill-gotten, tempt us to **sin**
  + Not **own**: belongs to God
+ But money can be **useful**:
  + to train up **faithfulness**
+ Financial **stewardship** 
  + is part of **discipleship**:
+ Having **enough** does **not** mean
  + we are good **stewards**!
+ E.g., child **allowance**: 
  + not for daily **needs**
  + but to teach **responsib**: 
...
what you will **eat** or what you will drink,<br/>
nor about your **body**, what you will **put on**. 

不要為生命憂慮吃甚麼，喝甚麼；<br/>
為身體憂慮穿甚麼。

[Matthew 6:25a (ESV/CUV) (p.1/2)](# "ref")
...
>>>
+ **All** our money is like piggy bank!
  + no **lack** / scarcity w/**Creator**
+ Challenges our **zero-sum** economics
+ If in **need**: no **fear** / anxiety
  + If abundance: no **pride**
+ All **worldly** wealth is **tiny**
+ compared to **riches** of God's inherit:
...
>>>
+ TWU office: need freq **remind** to
  + work from **psyche**, soul, life
+ Even in day-to-day **occupation**
+ Not bc **work** is vital (calculus)
+ **Training** grounds for future reward:
  + which is **abundant**, 
  + and **true**, 
  + and **ours** keep
...
---
<!-- .slide: data-background="white" -->
# In what "**little**" thing do I <br/> need to be more **faithful**? 

>>>
+ **guys**: tend to focus on **big** ideas
  + ladies: faithf "**impl** details"
+ Cultivate **faithfulness** in even 
  + **littlest** things entrusted by God
+ Write household **budget**, stick to it
  + Pay **debts**, fair **wages**
+ Diligent **student**, empl, spouse, parent
  + **not** bc teacher, boss **deserves**
+ but bc our faithful **Father** calls us 
  + to be **faithful** + trust in Him
...
[Luke 16:14 (ESV/CUV)](# "ref")
[Dozen](https://unsplash.com/photos/8wUVsR-w994 "caption")

>>>
+ Not took **offense**, but looked **down**:
+ "Jesus, you don't **underst**: 
  + We do love God, and also
  + enjoy **success** in life
  + What's wrong w/loving **both**?"
...
+ or do I just **accept** company's defn
...
+ Cultivate **faithfulness** 
  + in even littlest God gives me now
...
___________________________________________
+ Use worldly **wealth** to show **mercy**
  + even in **biz** rl
  + testify **Your** greater mercy to us
+ Rejoice even in **smallest** responsib.
  + opp. to cultivate **faithfulness** 
  + and increase our **faith** in You
+ Fix our **eyes** + **hearts** upon **You**
  + not **possess**, influence, security
+ Father who provides **abundantly**
  + **greater** reward, **true** + real
  + lasting inheritance of our **own**
